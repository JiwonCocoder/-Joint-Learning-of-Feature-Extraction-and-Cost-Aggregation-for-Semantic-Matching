...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_each_lr56_temp007_test_softmax', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_each_lr56_temp007_test_softmax'
