...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_comb_score_lr55_temp007_thres50_16_2', help='trained model filename')
...
parser.add_argument('--threshold_WTA', type=float, default=0.002, help='pixelCT_threshold')
parser.add_argument('--threshold_NET', type=float, default=0.0005, help='pixelCT_threshold')
...
print(args)
save_path = 'trainLog_ada_agg_both_comb_score_lr55_temp007_thres50_16_2'
