...
from lib.model_train.model_pixelCT_no_mask_both_woDetach import ImMatchNet
...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_each_lr55_temp1_woNETnorm_woDetach', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_each_lr55_temp1_woNETnorm_woDetach'
...
def weak_loss(model,batch,writer_position, normalization='softmax',alpha=30):
    ...
    return loss_pixelCT_NET_B_Avec_byNET_pos, loss_pixelCT_NET_B_Avec_byNET_neg
...
def process_epoch(mode,epoch,model,loss_fn,optimizer,dataloader,batch_preprocessing_fn, writer, use_cuda=True,log_interval=50):
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        loss_pixelCT_NET_B_Avec_byNET_pos, loss_pixelCT_NET_B_Avec_byNET_neg = loss_fn(model, tnf_batch, writer_position)
        ...
        score_pos_pixelCT = loss_pixelCT_NET_B_Avec_byNET_pos
        score_neg_pixelCT = loss_pixelCT_NET_B_Avec_byNET_neg
