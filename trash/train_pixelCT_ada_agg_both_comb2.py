...
from lib.model_train.model_pixelCT_mask_comb_FB_check import ImMatchNet
...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_comb_lr55_temp05_thres50', help='trained model filename')
...
parser.add_argument('--temperature', type=float, default=0.5, help='pixelCT_temperature')
...
print(args)
save_path = 'trainLog_ada_agg_both_comb_lr55_temp05_thres50'
...
def weak_loss(model,batch,writer_position, normalization='softmax',alpha=30):
    ...
    loss_pixelCT_NET_B_Avec_byComb_neg = calc_pixelCT_mask(nc_NET_A_Bvec, index_B[2], mask_B[2], args.temperature)
