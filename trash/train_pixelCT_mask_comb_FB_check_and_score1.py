...
from lib.model_train.model_pixelCT_mask_comb_FB_check_and_score_max import ImMatchNet
...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_comb_score_lr55_temp007_thres50_16_1', help='trained model filename')
...
parser.add_argument('--threshold_WTA', type=float, default=0.001, help='pixelCT_threshold')
...
print(args)
save_path = 'trainLog_ada_agg_both_comb_score_lr55_temp007_thres50_16'
...
def weak_loss(model,batch,writer_position, normalization='softmax',alpha=30):
    ...
    return [loss_pixelCT_WTA_B_Avec_byWTA_pos, loss_pixelCT_WTA_B_Avec_byComb_pos], [loss_pixelCT_NET_B_Avec_byNET_pos, loss_pixelCT_NET_B_Avec_byComb_pos],[loss_pixelCT_WTA_B_Avec_byWTA_neg],[loss_pixelCT_NET_B_Avec_byNET_neg]
...
def process_epoch(mode,epoch,model,loss_fn,optimizer,dataloader,batch_preprocessing_fn, writer, use_cuda=True,log_interval=50):
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        score_neg_pixelCT_WTA = (loss_pixelCT_WTA_neg[0])
        score_neg_pixelCT_NET = (loss_pixelCT_NET_neg[0])
