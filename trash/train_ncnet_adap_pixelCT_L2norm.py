...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ncnet_adap_lr55_temp05_L2norm', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ncnet_adap_lr55_temp05_L2norm'
