...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ncnet_adap_lr55_temp05', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ncnet_adap_lr54_temp05'
...
def process_epoch(mode, epoch, model, loss_fn, optimizer, dataloader, batch_preprocessing_fn, writer, use_cuda=True,
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        loss_pixelCT_NET_B_Avec_by_NET_pos, loss_pixelCT_NET_B_Avec_by_NET_neg = loss_fn(model, tnf_batch, writer_position)
