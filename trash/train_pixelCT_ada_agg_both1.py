...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_both_lr55_temp1_L2normWTA', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_both_lr55_temp1_L2normWTA'
