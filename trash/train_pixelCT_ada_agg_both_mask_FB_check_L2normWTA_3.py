...
from lib.model_train.model_pixelCT_mask_both_FB_check_differ3 import ImMatchNet
...
# parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_mask100_55_temp5_L2normWTA', help='trained model filename')
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_mask25_55_temp1_L2normWTA', help='trained model filename')
# parser.add_argument('--trainLog', type=str, default='trainLog_ada_agg_both_mask100_55_temp5_L2normWTA', help='trained model filename')
parser.add_argument('--trainLog', type=str, default='trainLog_ada_agg_both_mask25_55_temp1_L2normWTA', help='trained model filename')
