...
from lib.model_train.model_ncnet_adap import ImMatchNet
...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ncnet_adap_img_lr54_test', help='trained model filename')
...
print(args)
save_path = './trainLog_ncnet_adap_img_lr54_test'
...
def weak_loss(model, batch, writer, writer_position, normalization='softmax', alpha=30):
    ...
    writer.add_scalar('Loss_train/score_neg', score_neg, writer_position)
    writer.add_scalar('Loss_train/score_pos', score_pos, writer_position)
