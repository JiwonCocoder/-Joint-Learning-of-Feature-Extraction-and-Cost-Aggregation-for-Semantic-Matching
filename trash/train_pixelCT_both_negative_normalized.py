...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_both_neg_fixed_lr7', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_both_neg_fixed_lr7'
...
def process_epoch(mode,epoch,model,loss_fn,optimizer,dataloader,batch_preprocessing_fn, writer, use_cuda=True,log_interval=50):
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        writer.add_scalar('Loss_{}/loss_pixelCT_WTA_B_Avec_pos'.format(mode), loss_pixelCT_WTA_B_Avec_pos, writer_position)
        writer.add_scalar('Loss_{}/loss_pixelCT_NET_B_Avec_pos'.format(mode), loss_pixelCT_NET_B_Avec_pos, writer_position)
        writer.add_scalar('Loss_{}/loss_pixelCT_WTA_B_Avec_neg'.format(mode), loss_pixelCT_WTA_B_Avec_neg, writer_position)
