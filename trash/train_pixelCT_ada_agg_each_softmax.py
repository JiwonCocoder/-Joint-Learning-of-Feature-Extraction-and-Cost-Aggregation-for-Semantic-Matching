...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_each_lr55_temp05_test_softmax', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_each_lr55_temp05_test_softmax'
...
def weak_loss(model,batch,writer_position, mode, normalization='softmax',alpha=30):
    ...
    nc_NET_A_Bvec = torch.nn.functional.softmax(nc_NET_A_Bvec)    
    #check
    # print("pos")
