...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_each_lr54', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_each_lr54'
...
def process_epoch(mode,epoch,model,loss_fn,optimizer,dataloader,batch_preprocessing_fn, writer, use_cuda=True,log_interval=50):
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        loss_pixelCT_WTA_B_Avec_byWTA_pos, loss_pixelCT_NET_B_Avec_byNET_pos, loss_pixelCT_WTA_B_Avec_byWTA_neg, loss_pixelCT_NET_B_Avec_byNET_neg = loss_fn(model, tnf_batch, writer_position)
