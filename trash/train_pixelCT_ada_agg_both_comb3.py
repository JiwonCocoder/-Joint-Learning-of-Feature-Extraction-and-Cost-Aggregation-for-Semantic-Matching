...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_comb_lr55_temp007_thres50', help='trained model filename')
...
print(args)
save_path = 'trainLog_ada_agg_both_comb_lr55_temp007_thres50'
