...
# parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_each_lr55_temp007_test', help='trained model filename')
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_each_lr55_temp100_test', help='trained model filename')
...
parser.add_argument('--temperature', type=float, default=100, help='pixelCT_temperature')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_each_lr55_temp007_test'
...
def weak_loss(model,batch,writer_position, mode, normalization='softmax',alpha=30):
    ...
    return loss_pixelCT_WTA_B_Avec_byWTA_pos, loss_pixelCT_NET_B_Avec_byNET_pos, loss_pixelCT_WTA_B_Avec_byWTA_neg, loss_pixelCT_NET_B_Avec_byNET_neg
...
def process_epoch(mode,epoch,model,loss_fn,optimizer,dataloader,batch_preprocessing_fn, writer, use_cuda=True,log_interval=50):
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        loss_pixelCT_WTA_B_Avec_byWTA_pos, loss_pixelCT_NET_B_Avec_byNET_pos, loss_pixelCT_WTA_B_Avec_byWTA_neg, loss_pixelCT_NET_B_Avec_byNET_neg = loss_fn(model, tnf_batch, writer_position, mode)

        score_pos_pixelCT = loss_pixelCT_WTA_B_Avec_byWTA_pos + loss_pixelCT_NET_B_Avec_byNET_pos
        score_neg_pixelCT = loss_pixelCT_WTA_B_Avec_byWTA_neg + loss_pixelCT_NET_B_Avec_byNET_neg        
        ...
        if writer_position % 9 == 0: 
            writer.add_scalar('Loss_{}/loss_pixelCT_WTA_B_Avec_byWTA_pos'.format(mode), loss_pixelCT_WTA_B_Avec_byWTA_pos, writer_position)
            writer.add_scalar('Loss_{}/loss_pixelCT_NET_B_Avec_byNET_pos'.format(mode), loss_pixelCT_NET_B_Avec_byNET_pos, writer_position)
            writer.add_scalar('Loss_{}/loss_pixelCT_WTA_B_Avec_byWTA_neg'.format(mode), loss_pixelCT_WTA_B_Avec_byWTA_neg,
                            writer_position)
            writer.add_scalar('Loss_{}/loss_pixelCT_NET_B_Avec_byNET_neg'.format(mode), loss_pixelCT_NET_B_Avec_byNET_neg, writer_position)
