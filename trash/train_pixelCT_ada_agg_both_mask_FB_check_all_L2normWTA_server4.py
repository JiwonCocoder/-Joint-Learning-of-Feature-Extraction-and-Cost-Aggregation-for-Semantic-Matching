...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_mask100_all_55_temp1_L2normWTA', help='trained model filename')
parser.add_argument('--trainLog', type=str, default='trainLog_ada_agg_both_mask100_all_55_temp1_L2normWTA', help='trained model filename')
...
print(args)
save_path = f'bsize_{args.batch_size}_lr_{args.lr}_temp_{args.temperature}_thres_{args.threshold}'
...
loss_fn = lambda model, batch, writer_position, mode: weak_loss(model, batch, writer_position, mode,
