...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_pixelCT_ada_agg_both_lr54_temp1', help='trained model filename')
...
print(args)
save_path = 'trainLog_pixelCT_ada_agg_both_lr54_temp1'
