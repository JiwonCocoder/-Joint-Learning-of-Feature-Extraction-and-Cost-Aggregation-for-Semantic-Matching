...
parser.add_argument('--result_model_fn', type=str, default='checkpoint_ada_agg_both_mask_differ_55_temp05', help='trained model filename')
parser.add_argument('--trainLog', type=str, default='trainLog_ada_agg_both_mask_differ_55_temp05', help='trained model filename')
