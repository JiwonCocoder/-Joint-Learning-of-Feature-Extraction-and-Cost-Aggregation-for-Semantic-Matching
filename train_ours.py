...
from lib.model_train.model_train_ours import ImMatchNet
...
train_name = f'{args.trainLog}_bsize_{args.batch_size}_lr_{args.lr}_temp_{args.temperature}_thres_ada_{args.occ_threshold_adap}_thres_agg_{args.occ_threshold_agg}'
