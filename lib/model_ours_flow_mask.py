...
from lib.showPlot import plot_test_map, plot_test_flow, plot_test_flow_mask, plot_test_map_mask
...
class ImMatchNet(nn.Module):
    ...
    def forward(self, tnf_batch):
        ...
        # occ4_fw_torch_img_final = torch.cat((occ_B_Avec_img, occ_B_Avec_img), dim=1)
        # occ4_fw_torch_img_final = torch.cat((occ4_fw_torch_img_final, occ_B_Avec_img), dim=1)
        # plot_test_flow_mask(tnf_batch['source_image'], tnf_batch['target_image'], Flow2D_WTA_B_Avec, occ_B_Avec_img, scale_factor=16,plot_name='AtoB_FLOW' )
        # plot_test_map_mask(tnf_batch['source_image'], tnf_batch['target_image'], Map2D_WTA_B_Avec, Map2D_WTA_B_Avec, occ_B_Avec_img, scale_factor=16,plot_name='AtoB_MAP' )
        ...
        if self.relocalization_k_size > 1:
            ...
            return Map2D_WTA_B_Avec, Map2D_NET_B_Avec, occ_B_Avec
