...
class ImMatchNet(nn.Module):
    ...
    def forward(self, tnf_batch):
        ...
        Map2D_WTA = unNormMap1D_to_NormMap2D(index1D_B)  # (B,2,S,S)
        ...
        # nc_B_Avec2 = torch.nn.functional.softmax(nc_B_Avec2, 1)
        MAP2D_NET, FLOW2D_NET = self.find_correspondence(nc_B_Avec2)
        # scores_B2, index_B2 = torch.max(nc_B_Avec2, dim=1)
        # index1D_B2 = index_B2.view(batch_size, -1)
        # Map2D_NET = unNormMap1D_to_NormMap2D(index1D_B2)  # (B,2,S,S)
        ...
        if self.relocalization_k_size > 1:
            ...
            return corr4d, Map2D_WTA, MAP2D_NET
