...
from lib.matching_model import unNormMap1D_to_NormMap2D, NormMap2D_to_unNormMap2D, unNormMap1D_to_NormMap2D_inLoc
...
class ImMatchNet(nn.Module):
    ...
    def forward(self, tnf_batch):
        ...
        if self.relocalization_k_size > 1:
            print(corr4d.size())
            print(self.relocalization_k_size)
        ...
        print(index_WTA_B.size())
        print(index1D_WTA_B.size())
        Map2D_WTA = unNormMap1D_to_NormMap2D_inLoc(index1D_WTA_B, index_WTA_B.size(1), index_WTA_B.size(2))  # (B,2,S,S)
